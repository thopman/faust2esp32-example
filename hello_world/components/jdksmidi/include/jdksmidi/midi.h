...
enum
{
    ...
    RESET          = 0xFF, ///< reset byte on the serial line. We never used as reset in a jdksMIDIMessage object,
...
/// except when a meta-event is in a jdksMIDIMessage, there is a limit
/// of 5 data bytes. So the format of the meta-events in a jdksMIDIMessage
...
// internal service number for jdksMIDIMessage::service_num message variable
