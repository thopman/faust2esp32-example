...
///
/// The jdksMIDIMessage class is a simple, lightweight container which can hold a single
...
/// for a number of jdksMIDIMessage variants, such as the MIDIBigMessage, MIDITimedMessage,
...
public:
    ...
    jdksMIDIMessage(); ///< Create a jdksMIDIMessage object which holds no values.

    jdksMIDIMessage ( const jdksMIDIMessage &m ); ///< Copy Constructor.

    const jdksMIDIMessage & operator = ( const jdksMIDIMessage &m ); ///< The assignment operator. Copies the jdksMIDIMessage value.

    void Clear() ///< Set the jdksMIDIMessage object to 0
    {
        status = 0;
        byte1 = byte2 = byte3 = 0;
        byte4 = byte5 = byte6 = 0;
    ...
    void Copy ( const jdksMIDIMessage & m ); ///< Copy the value of the specified jdksMIDIMessage.
    ...
    /// \note Sysex messages are not stored in the jdksMIDIMessage object. \see MIDIBigMessage
    ...
    friend bool operator == ( const jdksMIDIMessage &m1, const jdksMIDIMessage &m2 );
...
///
/// The MIDIBigMessage inherits from a jdksMIDIMessage and adds the capability of storing
...
class MIDIBigMessage : public jdksMIDIMessage
{
public:
    ...
    MIDIBigMessage ( const jdksMIDIMessage &m );

    MIDIBigMessage ( const jdksMIDIMessage &m, const MIDISystemExclusive *e );

    const MIDIBigMessage &operator = ( const MIDIBigMessage &m );

    const MIDIBigMessage &operator = ( const jdksMIDIMessage &m );


    void Copy ( const MIDIBigMessage &m );

    void Copy ( const jdksMIDIMessage &m );
...
class MIDITimedMessage : public jdksMIDIMessage
{
public:
    ...
    MIDITimedMessage ( const jdksMIDIMessage &m );
    ...
    const MIDITimedMessage &operator = ( const jdksMIDIMessage & m );
...
class MIDIDeltaTimedMessage : public jdksMIDIMessage
{
public:
    ...
    MIDIDeltaTimedMessage ( const jdksMIDIMessage &m );
    ...
    const MIDIDeltaTimedMessage &operator = ( const jdksMIDIMessage &m );
...
public:
    ...
    MIDITimedBigMessage ( const jdksMIDIMessage &m );
    ...
    const MIDITimedBigMessage &operator = ( const jdksMIDIMessage & m );
...
public:
    ...
    MIDIDeltaTimedBigMessage ( const jdksMIDIMessage &m );
    ...
    const MIDIDeltaTimedBigMessage &operator = ( const jdksMIDIMessage &m );
