...
public:
    ...
    virtual bool Parse ( uchar b, jdksMIDIMessage *msg );
...
protected:
    ...
    jdksMIDIMessage tmp_msg;
    MIDISystemExclusive *sysex;
    State  state;

    bool ParseSystemByte ( uchar b, jdksMIDIMessage *msg );
    bool ParseDataByte ( uchar b, jdksMIDIMessage *msg );
